...
export function AutomationPage({ onUnauthorized }: { onUnauthorized: () => void }) {
  ...
  async function reloadAll() { await Promise.all([settings.reload(), usage.reload(), jobs.reload(), rules.reload(), runs.reload(), bulkAudits.reload()]); }
