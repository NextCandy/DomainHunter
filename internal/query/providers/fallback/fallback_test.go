...
func testServer() *httptest.Server {
	return httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "registered.im":
			_, _ = w.Write([]byte(`{"code":0,"msg":"ok","data":{"registered":true,"reserved":false,"unknown":false,"registrar":"Example Registrar","creationDate":"2020-01-02T03:04:05Z","expirationDate":"2030-01-02T03:04:05Z","updatedDate":"2025-01-02T03:04:05Z","nameServers":["ns1.example.test"],"whoisData":"Domain Name: registered.im\nRegistrant Street: Redacted | Registry Policy"}}`))
		case "available.do":
